...
export const environment = {
  production: false,
  // apiUrl: 'https://healthgrants.pshealthpunjab.gov.pk/api', 
 ...
 //  apiUrl: 'https://gamatypingservices-dsfmf8ckf0asayed.canadacentral-01.azurewebsites.net/api',
  //apiUrl: 'https://localhost:7082/api',
   ...
   uiURL: "https://localhost:4200",
    ...
    crystalReportURL: "https://localhost:44369/api",
    hcpApiURL: "https://localhost:7042/api",
    encryptionPassword:"A12-s258Ad-958jLqp98cDmG",
    bootStrapurl:"http://localhost:4200/assets/printstyles/boostrapJs.min.css",
    emcApiURL:"https://localhost:7031/api",
    healthCouncilApiURL:"https://localhost:7280/api",
    DashboardApiURL : "https://localhost:7038/api",
    measApiURL: "https://localhost:7111/api",
